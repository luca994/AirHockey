function move() {
	...
	var S2 = utils.multiplyMatrices(utils.MakeRotateXMatrix(45), utils.MakeScaleMatrix(2));
	S2 = utils.multiplyMatrices(utils.MakeRotateYMatrix(30), S2);
	S2 = utils.multiplyMatrices(utils.MakeTranslateMatrix(1,1,-2), S2);
