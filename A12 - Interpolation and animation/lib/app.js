...
function animCall(t, mode) {
	...
	var cx = [animFrames[arrayElId][1][0], animFrames[arrayElId][3][0],
		  2*animFrames[nextElId][3][0] - animFrames[nextElId][1][0], animFrames[nextElId][1][0]];
	var cy = [animFrames[arrayElId][1][1], animFrames[arrayElId][3][1],
		  2*animFrames[nextElId][3][1] - animFrames[nextElId][1][1], animFrames[nextElId][1][1]];
	var cz = [animFrames[arrayElId][1][2], animFrames[arrayElId][3][2],
		  2*animFrames[nextElId][3][2] - animFrames[nextElId][1][2], animFrames[nextElId][1][2]];

	var qa0 = animFrames[arrayElId][2];
	var qa1 = animFrames[arrayElId][4];
	var qa3 = animFrames[nextElId][2];
	var qa2 = qa3.slerp(animFrames[nextElId][4])(-1);
	...
	if(mode) {
		return anim(cx, cy, cz, qx, qy, qz, qw, alpha);
	} else {
